...
const { jsonRpcError, jsonRpcResponse } = require("@grainulation/barn/mcp");
const { isInsideDir } = require("@grainulation/barn/paths");
const { installCrashHandlers } = require("@grainulation/barn/mcp-crash");
